...
function cached_quadratic_program_info(qp::Union{QuadraticProgrammingProblem, CuQuadraticProgrammingProblem})

    if isa(qp, QuadraticProgrammingProblem)
    ...
    elseif isa(qp, CuQuadraticProgrammingProblem)
        return CachedQuadraticProgramInfo(
