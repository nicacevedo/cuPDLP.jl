...
function test()
    ...
    base_output_dir = "./output/PDHG_test33/"
    ...
    if data_source == "MIPLIB"
        if data_size == "tiny_instances" || contains(data_size,"instances_")
            ...
            # instances =  ["bppc6-02", "glass4", "ns1456591" ] # 
            instances = ["2club200v15p5scn"]#, "a2864-99blp", "ex10"]#, "ex1010-pi", "fhnw-schedule-pairb400", "fiball", "neos-1593097", "neos-2629914-sudost"]
            # Original
            # 1. Tiny
        ...
        for solving_method in solving_methods
            ...
            for alpha in real_alphas
                ...
                if solving_method == "direct_cuPDLP"
                    ...
                    main(instance_dir, output_dir_instance, objective_tol, time_sec_limit, ir_instead_restart)
