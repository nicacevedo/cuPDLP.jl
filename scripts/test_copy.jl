...
function test()
    ...
    solving_methods = [
        ...
        # "D3_D2_iterative_swap",     # NEW NEW ONE
        # "D3_D2_iterative_swap_indep", 
        # "D3_D2_mix", 
        # "D3_D2_mix_pure", 
    ...
    if data_source == "MIPLIB"
        if data_size == "tiny_instances" || contains(data_size,"instances_")
            instances = ["glass4"]#["irish-electricity", "lr1dr12vc10v70b-t360", "lr2-22dr3-333vc4v17a-t60", "map06", "map10", "map18", "neos-4391920-timok", "proteindesign121pgb11p9", "dlr1", "neos-4332801-seret"] # Instances that fail to converge on certain tolerance
